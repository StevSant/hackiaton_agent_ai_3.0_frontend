...
@Component({
  ...
  template: `
    <div class="bg-surface border border-line border-t-2 border-t-[#8b5cf6] rounded-lg p-3 shadow-1 h-full flex flex-col">
      ...
      @if (anomalies().length === 0) {
        <div class="flex-1 min-h-0 flex flex-col items-center justify-center gap-1 text-center px-2 py-3">
        ...
        <div class="space-y-1.5 flex-1 min-h-0 overflow-y-auto scroll-pretty">
