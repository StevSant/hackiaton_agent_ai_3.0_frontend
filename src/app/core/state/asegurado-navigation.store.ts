...
const SESSION_KEY = 'centinela:asegurado-nav-ids:v1';

export interface AseguradoNavigationNeighbors {
  prevId: string | null;
  nextId: string | null;
  position: number;
  total: number;
...
export class AseguradoNavigationStore {
  ...
  resolve(currentId: string, fallbackOrderedIds: readonly string[] = []): AseguradoNavigationNeighbors {
