...
const SESSION_KEY = 'centinela:provider-nav-ids:v1';

export interface ProviderNavigationNeighbors {
  prevId: string | null;
  nextId: string | null;
  position: number;
  total: number;
...
export class ProviderNavigationStore {
  ...
  resolve(currentId: string, fallbackOrderedIds: readonly string[] = []): ProviderNavigationNeighbors {
